...
def streamlit_config():
   ...
   # st.set_page_config(page_title='Airbnb',
    ...
    nalini = pymongo.MongoClient("mongodb://gopiashokan:gopiroot@ac-0vdscni-shard-00-00.xdp3lkp.mongodb.net:27017,ac-0vdscni-shard-00-01.xdp3lkp.mongodb.net:27017,ac-0vdscni-shard-00-02.xdp3lkp.mongodb.net:27017/?ssl=true&replicaSet=atlas-11e4qv-shard-0&authSource=admin&retryWrites=true&w=majority")
    db = nalini['sample_airbnb']
    col = db['listingsAndReviews']
    df = pd.read_csv(r"C:\Users\jayar\Desktop\sample_airbnb.listingsAndReviews (1) (1).csv")
...
class data_collection:
   # nalini = pymongo.MongoClient("mongodb://nalini:naliniroot@ac-0vdscni-shard-00-00.xdp3lkp.mongodb.net:27017,ac-0vdscni-shard-00-01.xdp3lkp.mongodb.net:27017,ac-0vdscni-shard-00-02.xdp3lkp.mongodb.net:27017/?ssl=true&replicaSet=atlas-11e4qv-shard-0&authSource=admin&retryWrites=true&w=majority")
    #db = nalini['sample_airbnb']
    #col = db['listingsAndReviews']
...
class feature:
    ...
    def feature(column_name, order='count desc', limit=10):
        nalini = psycopg2.connect(host='localhost',
                                user='postgres',
                                password='akhil',
                                database='airbnb')
        cursor = nalini.cursor()
